...
//			level: "level",			  //层级
  ...
  DTree.prototype.setting = function(options) {
    ...
    this.normalizeData = this.options.normalizeData || OPTIONS.normalizeData || function(res){return res};
  ...
  DTree.prototype.asyncLoadTree = function(first, $ul, callback){
    ...
    AjaxHelper.request({
      ...
      success: function(result) {
        ...
        // 格式化数据
        result = _this.normalizeData(result);
        // 加载完毕后执行树解析前的回调
...
//                console.log("winHeight = " + winHeight);
  ...
  exports('dtree', dtree);
}).addcss('../../../vendor/dtree/dtree.css')
  .addcss('../../../vendor/dtree/font/dtreefont.css');
