    ...
    */
    ...
    'admin' => [
        'roles' => [
            ...
            'updated' => 'نقش کاربر با موفقیت به‌روز رسانی شد.',
        ],

        'users' => [
            'cant_resend_confirmation' => 'برنامه در حال حاضر به صورت دستی کاربران را تأیید می‌کند.',
            ...
            'updated' => 'کاربر با موفقیت به‌روز رسانی شد.',
            'updated_password' => 'گذرواژه‌ی کاربر با موفقیت به‌روز رسانی شد.',
        ],
        ...
        'document' => [
            ...
            'updated' => 'پرونده با موفقیت به‌روز رسانی شد.',
        ],
        ...
        'center' => [
            ...
            'updated' => 'مرکز با موفقیت به‌روز رسانی شد.',
        ],
        ...
        'station' => [
            ...
            'updated' => 'ایستگاه با موفقیت به‌روز رسانی شد.',
        ],
    ],
