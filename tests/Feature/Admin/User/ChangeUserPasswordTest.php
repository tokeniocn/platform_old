...
class ChangeUserPasswordTest extends TestCase
{
    ...
    public function the_user_password_can_be_changed()
    {
        ...
        $response->assertSessionHas(['flash_success' => __('alerts.admin.users.updated_password')]);

        Event::assertDispatched(UserPasswordChanged::class);
    }

    /** @test */
    public function an_admin_can_use_the_same_password_when_history_is_off_on_admin_user_password_change()
    {
    ...
    /** @test */
    public function an_admin_can_not_use_the_same_password_when_history_is_on_on_admin_user_password_change()
    {
