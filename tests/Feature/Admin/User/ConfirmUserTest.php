...
class ConfirmUserTest extends TestCase
{
    ...
    public function an_admin_can_confirm_a_user()
    {
        ...
        $response->assertSessionHas(['flash_success' => __('alerts.admin.users.confirmed')]);
    }
    ...
    public function an_admin_cannot_confirm_a_confirmed_user()
    {
        ...
        $response = $this->get("/admin/auth/user/{$user->id}/confirm");
        $response->assertSessionHas(['flash_danger' => __('exceptions.admin.access.users.already_confirmed')]);
    }
    ...
    public function an_admin_can_unconfirm_a_user()
    {
        ...
        $response->assertSessionHas(['flash_success' => __('alerts.admin.users.unconfirmed')]);
    }
    ...
    public function an_admin_cannot_unconfirm_an_unconfirmed_user()
    {
        ...
        $response = $this->get("/admin/auth/user/{$user->id}/unconfirm");
        $response->assertSessionHas(['flash_danger' => __('exceptions.admin.access.users.not_confirmed')]);
    }
    ...
    public function an_admin_cannot_be_unconfirmed()
    {
        ...
        $response->assertSessionHas(['flash_danger' => __('exceptions.admin.access.users.cant_unconfirm_admin')]);
    }
    ...
    public function a_user_cannot_unconfirm_self()
    {
        ...
        $response->assertSessionHas(['flash_danger' => __('exceptions.admin.access.users.cant_unconfirm_self')]);
    }
