...
class DeleteUserTest extends TestCase
{
    ...
    public function a_user_must_be_soft_deleted_before_permanently_deleted()
    {
        ...
        $response->assertSessionHas(['flash_danger' => __('exceptions.admin.access.users.delete_first')]);
    }
    ...
    public function an_admin_can_restore_users()
    {
        ...
        $response->assertSessionHas(['flash_success' => __('alerts.admin.users.restored')]);
    ...
    public function a_user_can_be_permanently_deleted()
    {
        ...
        $response->assertSessionHas(['flash_success' => __('alerts.admin.users.deleted_permanently')]);
    ...
    public function a_not_deleted_user_cant_be_restored()
    {
        ...
        $response->assertSessionHas(['flash_danger' => __('exceptions.admin.access.users.cant_restore')]);
    }
    ...
    public function a_user_can_be_deleted()
    {
        ...
        $response->assertSessionHas(['flash_success' => __('alerts.admin.users.deleted')]);
